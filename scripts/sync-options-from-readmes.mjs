...
const PACKAGE_ORDER = [
  ...
  'echarts-error-chart',
  'echarts-lollipop',
  'echarts-algorithm-sort',
  'echarts-algorithm-shortest-path',
  'echarts-seasonal-radial',
  'echarts-beeswarm',
  'echarts-spiral',
  'echarts-smith',
...
function titleForPackage(packageName, locale) {
  const titles = {
    ...
    zh: {
      ...
      'echarts-error-chart': '误差图',
      'echarts-lollipop': '棒棒糖图',
      'echarts-algorithm-sort': '排序算法',
      'echarts-algorithm-shortest-path': '最短路径算法',
      'echarts-seasonal-radial': '季节径向图',
