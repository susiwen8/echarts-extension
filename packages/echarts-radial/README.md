...
```bash
npm install echarts echarts-radial
```
...
<script src="../dist/echarts-radial.js"></script>
```
...
```bash
npm --workspace echarts-radial run build:ts
npm --workspace echarts-radial run build
```
