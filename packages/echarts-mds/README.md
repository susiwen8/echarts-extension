...
![MDS chart](../../visual-baseline/echarts-mds.png)
...
| --- | --- | --- |
| `type` | Registers this package series with ECharts. | `'mds'` |
...
| `layout.linkDistance` | Distance represented by one graph step. Same effect as linkDistance. | `number` |
| `layout.preventOverlap` | Separates nodes after MDS placement. Same effect as preventOverlap. | `boolean` |
| `layout.maxPreventOverlapIteration` | Maximum overlap-prevention iterations. Same effect as maxPreventOverlapIteration. | `number` |
| `layout.nodeSize` | Node size used by overlap prevention. Same effect as nodeSize. | `number \| number[] \| function` |
| `layout.nodeSpacing` | Extra node spacing used by overlap prevention. Same effect as nodeSpacing. | `number \| function` |
| `linkDistance` | Same effect as layout.linkDistance. Distance represented by one graph step. | `number` |
| `preventOverlap` | Same effect as layout.preventOverlap. Separates nodes after MDS placement. | `boolean` |
| `maxPreventOverlapIteration` | Same effect as layout.maxPreventOverlapIteration. Maximum overlap-prevention iterations. | `number` |
| `nodeSize` | Same effect as layout.nodeSize. Node size used by overlap prevention. | `number \| number[] \| function` |
