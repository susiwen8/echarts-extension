...
export function resolveMosaicLayout(option = {}) {
    const layoutOptions = {
        ...
        dimensions: Array.isArray(option.dimensions) ? option.dimensions.filter((item) => typeof item === 'string') : undefined,
...
export function layoutMosaic(data, options = {}) {
