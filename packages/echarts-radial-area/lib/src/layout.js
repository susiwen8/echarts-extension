...
export function resolveRadialAreaLayout(option = {}) {
...
export function layoutRadialArea(data, options = {}) {
    ...
    const innerRadius = clampRadius(parseRadius(radiusOption?.[0] ?? options.innerRadius ?? DEFAULT_INNER_RADIUS, radiusLimit, parseRadius(DEFAULT_INNER_RADIUS, radiusLimit, radiusLimit * 0.42)), 0, radiusLimit);
