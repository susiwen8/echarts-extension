...
<head>
  ...
  <title>echarts-venn bubble example</title>
  <link rel="icon" href="../../../favicon.svg" type="image/svg+xml">
  <link rel="stylesheet" href="../../shared/demo-page.css?v=interactions-4">
</head>
<body class="demo-page" data-example="venn-bubble">
  <main class="demo-shell">
    <header class="demo-header">
      <div>
        <p class="eyebrow">echarts-venn</p>
        <h1>Bubble Venn</h1>
        <p>Value-sized translucent circles provide a compact bubble-style case.</p>
      </div>
  ...
  <script src="../../../packages/echarts-venn/dist/echarts-venn.js"></script>
