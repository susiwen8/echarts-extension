...
<head>
  ...
  <title>echarts-venn hollow example</title>
  <link rel="icon" href="../../../favicon.svg" type="image/svg+xml">
  <link rel="stylesheet" href="../../shared/demo-page.css?v=interactions-4">
</head>
<body class="demo-page" data-example="venn-hollow">
  <main class="demo-shell">
    <header class="demo-header">
      <div>
        <p class="eyebrow">echarts-venn</p>
        <h1>Hollow Venn</h1>
        <p>Three-set outlines expose the set and intersection label regions.</p>
      </div>
