...
<head>
  ...
  <title>echarts-mosaic example</title>
  <link rel="icon" href="../../../favicon.svg" type="image/svg+xml">
  <link rel="stylesheet" href="../../shared/demo-page.css?v=interactions-4">
</head>
<body class="demo-page" data-example="mosaic">
  <main class="demo-shell">
    <header class="demo-header">
      <div>
        <p class="eyebrow">echarts-mosaic</p>
        <h1>Mosaic</h1>
        <p>Category totals size each column while subcategories split the vertical area.</p>
      </div>
  ...
  <script src="../../../packages/echarts-mosaic/dist/echarts-mosaic.js"></script>
