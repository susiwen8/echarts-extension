...
<head>
  ...
  <title>echarts-error-chart example</title>
  <link rel="icon" href="../../../favicon.svg" type="image/svg+xml">
  <link rel="stylesheet" href="../../shared/demo-page.css?v=interactions-5">
</head>
<body class="demo-page" data-example="error-chart">
  ...
  <script src="../../../packages/echarts-error-chart/dist/echarts-error-chart.js"></script>
  <script src="../../shared/demo-runner.js?v=error-chart-main"></script>
</body>
</html>
