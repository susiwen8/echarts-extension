...
<head>
  ...
  <title>echarts-arc example</title>
  <link rel="icon" href="../../../favicon.svg" type="image/svg+xml">
  <link rel="stylesheet" href="../../shared/demo-page.css?v=interactions-4">
</head>
<body class="demo-page" data-example="arc">
  <main class="demo-shell">
    <header class="demo-header">
      <div>
        <p class="eyebrow">echarts-arc</p>
        <h1>Arc</h1>
        <p>Ordered graph nodes are connected with animated arced edge paths.</p>
      </div>
  ...
  <script src="../../../packages/echarts-arc/dist/echarts-arc.js?v=hover-transition"></script>
