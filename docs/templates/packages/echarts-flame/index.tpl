...
<head>
  ...
  <title>echarts-flame example</title>
  <link rel="icon" href="../../../favicon.svg" type="image/svg+xml">
  <link rel="stylesheet" href="../../shared/demo-page.css?v=interactions-4">
</head>
<body class="demo-page" data-example="flame">
  <main class="demo-shell">
    <header class="demo-header">
      <div>
        <p class="eyebrow">echarts-flame</p>
        <h1>Flame</h1>
        <p>Hierarchical values are laid out as a profile flame graph.</p>
      </div>
  ...
  <script src="../../../packages/echarts-flame/dist/echarts-flame.js"></script>
