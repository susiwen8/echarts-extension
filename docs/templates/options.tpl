...
<body class="options-page">
  <main class="gallery-shell">
    ...
    <section class="options-search" aria-label="Search package options">
      <label class="options-search__label" for="options-search">Search</label>
      <div class="options-search__field">
        <input id="options-search" type="search" placeholder="Chart, option, description, or value" autocomplete="off">
        <button id="options-search-clear" type="button">Clear</button>
      </div>
