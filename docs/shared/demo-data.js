(function (root) {
  ...
  const data = {
    ...
    errorChart: [
      ...
      { name: 'Knit', cost: 135, price: 355, costLow: 123, costHigh: 151, priceLow: 333, priceHigh: 386, itemStyle: { color: '#4aa3df' } },
      { name: 'Shorts', cost: 144, price: 157, costLow: 126, costHigh: 157, priceLow: 131, priceHigh: 190, itemStyle: { color: '#4aa3df' } },
      { name: 'Shirt', cost: 173, price: 205, costLow: 151, costHigh: 188, priceLow: 184, priceHigh: 250, itemStyle: { color: '#4aa3df' } },
      { name: 'Coat', cost: 278, price: 790, costLow: 255, costHigh: 296, priceLow: 762, priceHigh: 829, itemStyle: { color: '#4aa3df' } },
      { name: 'Pants', cost: 296, price: 409, costLow: 278, costHigh: 318, priceLow: 386, priceHigh: 429, itemStyle: { color: '#4aa3df' } },
      { name: 'Jacket', cost: 309, price: 543, costLow: 289, costHigh: 318, priceLow: 507, priceHigh: 575, itemStyle: { color: '#4aa3df' } },
      { name: 'Suit', cost: 389, price: 443, costLow: 372, costHigh: 415, priceLow: 412, priceHigh: 483, itemStyle: { color: '#4aa3df' } },
      { name: 'Cardigan', cost: 409, price: 604, costLow: 394, costHigh: 421, priceLow: 583, priceHigh: 628, itemStyle: { color: '#4aa3df' } },
      { name: 'Bag', cost: 432, price: 428, costLow: 409, costHigh: 453, priceLow: 400, priceHigh: 464, itemStyle: { color: '#4aa3df' } },
      { name: 'Dress', cost: 439, price: 519, costLow: 418, costHigh: 456, priceLow: 489, priceHigh: 566, itemStyle: { color: '#4aa3df' } },
      { name: 'Boots', cost: 479, price: 633, costLow: 448, costHigh: 488, priceLow: 594, priceHigh: 653, itemStyle: { color: '#4aa3df' } },
      { name: 'Sneaker', cost: 505, price: 527, costLow: 490, costHigh: 527, priceLow: 487, priceHigh: 552, itemStyle: { color: '#4aa3df' } },
      { name: 'Scarf', cost: 545, price: 588, costLow: 519, costHigh: 556, priceLow: 560, priceHigh: 625, itemStyle: { color: '#4aa3df' } },
      { name: 'Gown', cost: 678, price: 790, costLow: 660, costHigh: 690, priceLow: 760, priceHigh: 825, itemStyle: { color: '#4aa3df' } }
    ],
    lollipop: [
