...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'echarts-cause-effect': path.join(root, 'packages/echarts-cause-effect/index.ts'),
      ...
      'echarts-organization-chart': path.join(root, 'packages/echarts-organization-chart/index.ts'),
